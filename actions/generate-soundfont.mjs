/*
	https://github.com/gleitz/MIDI.js/blob/master/generator/nodejs/packageWAVs.js
	------------------------------------------------------
...
import { readFile, existsSync, mkdirSync, writeFileSync, readFileSync, writeFileSync } from 'fs'
...
MIDI.Soundfont["' + instrumentName + '"] = ';
	...
	///
	var js = header + JSON.stringify(ret);
