...
})({"8V2mq":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "dd8c97620facbf8d";
"use strict";
...
},{}],"gFd9w":[function(require,module,exports) {
 ...
 */ class BitCrusherProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs, parameters) {
        ...
        for(let channel = 0; channel < channels; ++channel){
            ...
            let step = Math.pow(0.5, depth);
            for(let i = 0; i < size; ++i){
                const reduction = frequencyReduction[i];
                // We only take care |bitDepth| because |frequencuReduction| will always
                // have 128 values.
                if (!isBitDepthConstant) step = Math.pow(0.5, bitDepth[i]);
                if (!isNaN(reduction)) {
...
},{}]},["8V2mq","gFd9w"], "gFd9w", "parcelRequireaaed")

//# sourceMappingURL=bitcrusher.worklet.0facbf8d.js.map
