...
})({"791dcc356580b9ea6e876112c5821f51":[function(require,module,exports) {
"use strict";
...
var socialIcons = _interopRequireWildcard(require("./social-icons.js"));
...
class ShareMenu extends HTMLElement {
  constructor() {
    ...
    this._supportedSocials = {
      ...
      facebook: {
        ...
        action: () => {
          if (window.FB) {
            ...
            this._openWindow(`https://www.facebook.com/sharer.php?u=${this._encode(this.url)}&description=${this._encode(this.title)}%0A%0A${this._encode(this.text)}`);
          }
        }
      },
      twitter: {
      ...
      sms: {
        ...
        title: 'SMS',
        action: () => {
          let separator = '?'; // iOS uses two different separators, so we have to check the iOS version and use the proper one
  ...
  share({
    ...
    if (navigator.share) {
      return navigator.share({
        ...
        this.opened = false;
        ['share', 'close'].forEach(event => this._emitEvent(event, {
          origin: 'native'
        }));
      }).catch(({
        name
  ...
  _renderSocials() {
    ...
    this._socials.forEach((social, index) => {
      ...
      socialIcon.innerHTML = `<svg viewBox="0 0 256 256"><path d="${socialIcons[social]}"/></svg>`;
...
ShareMenu.observedAttributes = ['dialog-title', 'opened', 'url', 'is-image', 'no-backdrop'];
...
},{"./social-icons.js":"7790781bcd2e16b898fa12fd37dc3727"}],"7790781bcd2e16b898fa12fd37dc3727":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.yahoo = exports.xing = exports.wordpress = exports.whatsapp = exports.weibo = exports.vk = exports.viber = exports.twitter = exports.tumblr = exports.translate = exports.telegram = exports.stumbleupon = exports.sms = exports.skype = exports.reddit = exports.qzone = exports.print = exports.pocket = exports.pinterest = exports.okru = exports.myspace = exports.livejournal = exports.linkedin = exports.line = exports.instapaper = exports.flipboard = exports.facebook = exports.evernote = exports.email = exports.douban = exports.digg = exports.clipboard = exports.buffer = exports.blogger = exports.baidu = void 0;
...
//# sourceMappingURL=share-menu.0e0a0438.js.map
