...
export const BUTTON_LEFT_SHOULDER_BUTTON = "lb"
export const BUTTON_RIGHT_SHOULDER_BUTTON = "rb"
export const BUTTON_LEFT_SHOULDER_TWO = "lt"
export const BUTTON_RIGHT_SHOULDER_TWO = "rt"

export const BUTTON_SELECT = "select"
export const BUTTON_START = "start"

export const BUTTON_LEFT_S = "ls"
export const BUTTON_RIGHT_S = "rs"
