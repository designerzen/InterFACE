import * as FaceLandmarkModels from './face-landmark-constants'

export const FACE_CONTOURS = FaceLandmarkModels.MEDIAPIPE_FACE_MESH_KEYPOINTS_BY_CONTOUR
...
/**
 * This defines one face
 */
export const createDefaultFaceModel = () => {
	return {
