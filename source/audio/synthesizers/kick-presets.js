...
export const PRESET_606_KICK = preset({
	name:"606 Kick",
	velocity:0.86,
	length:0.16,
	attack:0.0004,
...
export const PRESET_505_KICK = preset({
	name:"505 Kick",
	velocity:0.92,
	length:0.23,
	attack:0.0007,
...
export const PRESET_CASIO_RZ1_KICK = preset({
	name:"Casio RZ-1 Kick",
	velocity:0.9,
	length:0.2,
	attack:0.0005,
	decay:0.014,
...
export const PRESET_KORG_DDD1_KICK = preset({
	name:"Korg DDD-1 Kick",
	velocity:0.98,
	length:0.29,
	attack:0.0008,
	decay:0.026,
...
export const PRESET_KORG_KR55_KICK = preset({
	name:"Korg KR-55 Kick",
	velocity:0.82,
	length:0.19,
	attack:0.0012,
	decay:0.025,
...
export const PRESET_BOSS_DR55_KICK = preset({
	name:"Boss DR-55 Kick",
	velocity:0.8,
	length:0.17,
	attack:0.001,
	decay:0.022,
...
export const PRESET_OBERHEIM_DMX_KICK = preset({
	name:"Oberheim DMX Kick",
	velocity:1.06,
	length:0.3,
	attack:0.0004,
	decay:0.018,
...
export const PRESET_DRUMTRAKS_KICK = preset({
	name:"Sequential DrumTraks Kick",
	velocity:1,
	length:0.29,
	attack:0.0007,
	decay:0.024,
...
export const PRESET_SP1200_KICK = preset({
	name:"E-mu SP-1200 Kick",
	velocity:1.03,
	length:0.34,
	attack:0.0005,
	decay:0.03,
...
export const PRESET_YAMAHA_RX5_KICK = preset({
	name:"Yamaha RX5 Kick",
	velocity:1.04,
	length:0.27,
	attack:0.0004,
	decay:0.016,
...
export const PRESET_ALESIS_HR16_KICK = preset({
	name:"Alesis HR-16 Kick",
	velocity:1.02,
	length:0.31,
	attack:0.0006,
	decay:0.022,
...
export const PRESET_SIMMONS_SDSV_KICK = preset({
	name:"Simmons SDS-V Kick",
	velocity:1.1,
	length:0.48,
	attack:0.0004,
	decay:0.035,
