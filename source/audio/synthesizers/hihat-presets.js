...
export const OPEN_HIHAT_CRASH = open({
	...
	bandpassQ:0.58,
	lowpass:14500,
	ratios:[1.91, 2.73, 3.86, 5.18, 6.71, 8.43],
	type:"square",
	metallicGain:0.42,
	noiseGain:0.07,
	noiseAttack:0.008,
...
export const OPEN_HIHAT_CRASH_WARM = open({
	name:"Warm Studio Crash",
	velocity:0.92,
	length:2.8,
	fundamental:42,
	attack:0.006,
	...
	bandpassQ:0.55,
	lowpass:12800,
	ratios:[1.84, 2.66, 3.72, 4.96, 6.38, 8.02],
	type:"square",
	metallicGain:0.38,
	noiseGain:0.06,
	noiseAttack:0.012,
...
export const OPEN_HIHAT_CRASH_THIN = open({
	name:"Thin Jazz Crash",
	velocity:0.86,
	length:1.9,
	fundamental:58,
	attack:0.005,
	...
	bandpassQ:0.52,
	lowpass:15800,
	ratios:[1.96, 2.89, 4.04, 5.37, 6.94, 8.76],
	type:"square",
	metallicGain:0.34,
	noiseGain:0.05,
	noiseAttack:0.006,
...
export const OPEN_HIHAT_CRASH_DARK = open({
	name:"Vintage Dark Crash",
	velocity:0.9,
	length:3.2,
	fundamental:36,
	attack:0.008,
	...
	bandpassQ:0.6,
	lowpass:11200,
	ratios:[1.78, 2.51, 3.49, 4.71, 6.12, 7.68],
	type:"square",
	metallicGain:0.4,
	noiseGain:0.055,
	noiseAttack:0.014,
...
export const OPEN_HIHAT_CRASH_SUSPENDED = open({
	name:"Suspended Cymbal Swell",
	velocity:0.82,
	length:3.6,
	fundamental:45,
	attack:0.18,
	...
	bandpassQ:0.55,
	lowpass:13200,
	ratios:[1.87, 2.62, 3.64, 4.91, 6.44, 8.17],
	type:"square",
	metallicGain:0.28,
	noiseGain:0.08,
	noiseAttack:0.22,
