...
})({"fFgso":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "a8fb9c35fdafe466";
module.bundle.HMR_BUNDLE_ID = "6ad7335529d4de36";
"use strict";
...
},{}],"8gnca":[function(require,module,exports) {
// import {
...
const loop = (interval)=>{
    ...
    timerID = setTimeout(()=>{
        ...
        intervals++;
        postMessage({
            event: (0, _timingEventsJs.EVENT_TICK),
            time: passed,
            intervals
        });
...
const start = (interval = 250)=>{
    ...
    if (!isRunning) {
        ...
        isRunning = true;
        postMessage({
            event: (0, _timingEventsJs.EVENT_STARTING),
            time: 0
        });
    }
    gap = interval;
...
const stop = ()=>{
    ...
    isRunning = false;
    postMessage({
        event: (0, _timingEventsJs.EVENT_STOPPING),
        time: elapsed(),
        intervals
    });
};
self.onmessage = (e)=>{
    const data = e.data;
    switch(data.command){
        case 0, _timingEventsJs.CMD_START:
            accurateTiming = data.accurateTiming || false;
            start(data.interval);
            break;
        case 0, _timingEventsJs.CMD_STOP:
            stop();
            break;
        case 0, _timingEventsJs.CMD_UPDATE:
            start(data.interval);
            break;
    }
};

},{"./timing.events.js":"lpeCe"}],"lpeCe":[function(require,module,exports) {
...
},{}]},["fFgso","8gnca"], "8gnca", "parcelRequireaaed")

//# sourceMappingURL=timing.settimeout.worker.29d4de36.js.map
